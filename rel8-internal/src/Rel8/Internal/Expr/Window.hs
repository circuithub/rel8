module Rel8.Internal.Expr.Window
  ( cumulative
  , rowNumber
  , rank
  , denseRank
...
-- rel8
import Rel8.Internal.Aggregate (Aggregator' (Aggregator))
import Rel8.Internal.Expr ( Expr )
import Rel8.Internal.Expr.Opaleye ( fromColumn, fromPrimExpr, toColumn, toPrimExpr )
