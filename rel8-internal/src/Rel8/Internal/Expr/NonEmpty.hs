...
module Rel8.Internal.Expr.NonEmpty (
  head1Expr,
  index1Expr,
  last1Expr,
  shead1Expr,
...
import Rel8.Internal.Expr.Opaleye (mapPrimExpr, toPrimExpr)
import Rel8.Internal.Schema.Null (Nullify, Sql, Unnullify)
import Rel8.Internal.Type (DBType, typeInformation)
import Rel8.Internal.Type.Information (TypeInformation)
import qualified Rel8.Internal.Type.Array as Prim
