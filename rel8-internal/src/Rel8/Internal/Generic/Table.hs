...
module Rel8.Internal.Generic.Table
...
import Rel8.Internal.Generic.Table.ADT
  ( GSerializeADT, GColumnsADT, gtoResultADT, gfromResultADT
  )
import Rel8.Internal.Generic.Table.Record ( GSerialize, GColumns, gtoResult, gfromResult )
