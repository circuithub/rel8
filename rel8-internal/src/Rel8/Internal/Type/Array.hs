...
module Rel8.Internal.Type.Array
...
-- rel8
import Rel8.Internal.Schema.Null (Unnullify, Nullity (Null, NotNull))
import Rel8.Internal.Type.Builder.Fold (interfoldMap)
import Rel8.Internal.Type.Decoder (Decoder (..), Parser)
import Rel8.Internal.Type.Encoder (Encoder (..))
import Rel8.Internal.Type.Information (TypeInformation(..), parseTypeInformation)
import Rel8.Internal.Type.Name (TypeName (..), showTypeName)
import Rel8.Internal.Type.Nullable (NullableOrNot (..))
