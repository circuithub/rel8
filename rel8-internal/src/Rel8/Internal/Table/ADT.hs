...
module Rel8.Internal.Table.ADT
  ( ADT( ADT )
  , ADTable
  , BuildableADT
  , BuildADT, buildADT
...
import Rel8.Internal.Generic.Record ( Record( Record ), unrecord )
...
import qualified Rel8.Internal.Generic.Table.ADT as G
...
import Rel8.Internal.Table ( Table, TColumns )
