...
module Rel8.Internal.Table.Projection
  ( Projection
  , Projectable( project )
...
-- rel8
import Rel8.Internal.Schema.Field ( Field( Field ), fields )
import Rel8.Internal.Schema.HTable ( hfield, htabulate )
import Rel8.Internal.Table ( Columns, Context, Transpose, toColumns )
