...
module Rel8.Internal.Table.Bool
  ( bool
  , case_
  , nullable
  )
...
import Rel8.Internal.Expr.Bool ( boolExpr, caseExpr )
import Rel8.Internal.Expr.Null ( isNull, unsafeUnnullify )
import Rel8.Internal.Schema.HTable ( htabulate, hfield )
