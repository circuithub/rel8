...
module Rel8.Internal.Schema.HTable.Vectorize
  ( HVectorize
...
import Rel8.Internal.Schema.HTable.Identity ( HIdentity( HIdentity ) )
import Rel8.Internal.Schema.HTable.MapTable
  ( HMapTable( HMapTable ), HMapTableField( HMapTableField )
  , MapSpec, mapInfo
  , Precompose( Precompose )
  )
import qualified Rel8.Internal.Schema.HTable.MapTable as HMapTable ( hproject )
import Rel8.Internal.Schema.HTable.Nullify (HNullify (HNullify))
import Rel8.Internal.Schema.Null (Nullify, Unnullify, NotNull, Nullity (NotNull))
