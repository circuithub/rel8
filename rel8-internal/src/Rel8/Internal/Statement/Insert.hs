...
module Rel8.Internal.Statement.Insert
  ( Insert(..)
  , insert
  , ppInsert
  , ppInto
...
import Rel8.Internal.Schema.Name ( Name, Selects, ppColumn )
import Rel8.Internal.Schema.Table ( TableSchema(..), ppTable )
import Rel8.Internal.Statement (Statement)
import Rel8.Internal.Statement.OnConflict ( OnConflict, ppOnConflict )
import Rel8.Internal.Statement.Returning (Returning, ppReturning, runReturning)
import Rel8.Internal.Statement.Select ( ppRows )
import Rel8.Internal.Table ( Table )
import Rel8.Internal.Table.Name ( showNames )
