...
module Rel8.Internal.Statement.Select
  ( select
  , ppSelect
  , Optimized(..)
  , ppPrimSelect
...
import Rel8.Internal.Expr.Bool ( false )
import Rel8.Internal.Expr.Opaleye ( toPrimExpr )
import Rel8.Internal.Query ( Query )
import Rel8.Internal.Query.Opaleye ( toOpaleye )
import Rel8.Internal.Schema.Name ( Selects )
import Rel8.Internal.Statement (Statement, statementReturning)
import Rel8.Internal.Table ( Table )
import Rel8.Internal.Table.Cols ( toCols )
import Rel8.Internal.Table.Name ( namesFromLabelsTagged )
import Rel8.Internal.Table.Opaleye ( castTable, exprsWithNames )
import qualified Rel8.Internal.Table.Opaleye as T
