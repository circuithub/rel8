...
module Rel8.Internal.Statement.Returning
...
import Rel8.Internal.Statement (Statement, statementNoReturning, statementReturning)
import Rel8.Internal.Table (Table)
import Rel8.Internal.Table.Opaleye ( castTable, exprs, view )
