...
type instance
  Eval (GGSerialize 'Product _Serialize _Columns exprs rep) =
    GSerialize _Serialize _Columns exprs rep


type instance
  Eval (GGSerialize 'Sum _Serialize _Columns exprs rep) =
...
ggfromResult ::
  forall algebra _Serialize _Columns exprs rep x.
