...
fromIntegral :: (Sql DBIntegral a, Sql DBNum b, IsMaybe a ~ IsMaybe b)
  => Expr a -> Expr b
fromIntegral (Expr a) = castExpr (Expr a)


realToFrac :: (Sql DBNum a, Sql DBFractional b, IsMaybe a ~ IsMaybe b)
  => Expr a -> Expr b
realToFrac (Expr a) = castExpr (Expr a)


ceiling :: (Sql DBFractional a, Sql DBIntegral b, IsMaybe a ~ IsMaybe b)
  => Expr a -> Expr b
...
floor :: (Sql DBFractional a, Sql DBIntegral b, IsMaybe a ~ IsMaybe b)
  => Expr a -> Expr b
floor = function "FLOOR"


round :: (Sql DBFractional a, Sql DBIntegral b, IsMaybe a ~ IsMaybe b)
  => Expr a -> Expr b
round = function "ROUND"


truncate :: (Sql DBFractional a, Sql DBIntegral b, IsMaybe a ~ IsMaybe b)
  => Expr a -> Expr b
