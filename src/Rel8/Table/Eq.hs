...
import Rel8.Generic.Table.Record (GColumns, GTable, gtable)
import Rel8.Schema.Dict (Dict (Dict))
import Rel8.Schema.HTable (hfield, htabulateA)
import Rel8.Schema.HTable.Identity (HIdentity (HIdentity))
import Rel8.Schema.Null (Sql)
import Rel8.Table (Columns, TColumns, Table, toColumns)
...
instance
  (EqTable a, EqTable b, EqTable c, EqTable d, EqTable e) =>
  EqTable (a, b, c, d, e)
